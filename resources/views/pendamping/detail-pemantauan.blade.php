    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6">
                <button class="tab-button py-4 text-sm font-medium border-b-2 border-blue-500 text-blue-600" data-tab="pencairan">
                    Pencairan Dana
                </button>
                <button class="tab-button py-4 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700" data-tab="absensi">
                    Absensi Pertemuan
                </button>
                <button class="tab-button py-4 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700" data-tab="laporan">
                    Laporan Bulanan
                </button>
            </nav>
        </div>
        ...
        <div id="pencairan" class="tab-content p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <button class="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700" onclick="openPencairanModal()">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                @for($periode = 1; $periode <= 4; $periode++)
                    ...
                    @endphp
                    <div class="border rounded-lg p-4 {{ $pencairan && $pencairan->status == 'dicairkan' ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200' }}">
        ...
        <div id="absensi" class="tab-content p-6 hidden">
            <div class="flex items-center justify-between mb-6">
                ...
                <button class="px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700" onclick="openAbsensiModal()">
                    <i class="fas fa-plus mr-2"></i>
                    Update Absensi
                </button>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                @for($bulan = 1; $bulan <= 12; $bulan++)
                    ...
                    @endphp
                    <div class="border rounded-lg p-4 {{ $absensi && $absensi->status == 'hadir' ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200' }}">
                        <div class="flex items-center justify-between mb-3">
        ...
        <div id="laporan" class="tab-content p-6 hidden">
            <div class="flex items-center justify-between mb-6">
                ...
                <button class="px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700" onclick="openLaporanModal()">
                    <i class="fas fa-plus mr-2"></i>
                    Buat Laporan
                </button>
            </div>
            ...
            <div class="space-y-4">
                @for($bulan = 1; $bulan <= 12; $bulan++)
                    ...
                    @endphp
                    <div class="border rounded-lg p-4 {{ $laporan ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200' }}">
                        <div class="flex items-center justify-between mb-3">
            ...
            <form action="{{ route('pemantauan.update-pencairan', $penerima->id) }}" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="periode" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="tahun" value="{{ $tahunSekarang }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Jumlah</label>
                        <input type="number" name="jumlah" step="0.01" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Tanggal Cair</label>
                        <input type="date" name="tanggal_cair" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
                    </div>
                </div>
                <div class="flex justify-end space-x-3 mt-6">
                    <button type="button" onclick="closePencairanModal()" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">
                        Batal
                    </button>
            ...
            <form action="{{ route('pemantauan.update-absensi', $penerima->id) }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_pertemuan" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Keterangan</label>
                        <textarea name="keterangan" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
                ...
                <div class="flex justify-end space-x-3 mt-6">
                    <button type="button" onclick="closeAbsensiModal()" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">
                        Batal
                    </button>
            ...
            <form action="{{ route('pemantauan.update-laporan', $penerima->id) }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="kondisi_keluarga" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" required></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Pencapaian Komitmen</label>
                        <textarea name="pencapaian_komitmen" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" required></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Kendala</label>
                        <textarea name="kendala" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Rekomendasi</label>
                        <textarea name="rekomendasi" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
                    </div>
                </div>
                <div class="flex justify-end space-x-3 mt-6">
                    <button type="button" onclick="closeLaporanModal()" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">
                        Batal
                    </button>
