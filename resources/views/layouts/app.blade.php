...
<head>
    ...
    <!-- Custom Brown Theme -->
    <link href="{{ asset('css/custom-brown-theme.css') }}" rel="stylesheet">
    ...
    <style>
        ...
        .bg-gradient-primary {
            background: linear-gradient(135deg, #0A1128 0%, #1B263B 100%) !important;
        }
        .btn-primary {
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">E-PKH </div>
            </a>
            ...
            @auth
                ...
                <li class="nav-item {{ $menuLaporan ?? '' }}">
                    <a class="nav-link" href="{{ route('pendamping.laporan') }}">
            ...
            @auth
                ...
                <!-- Nav Item - Data Pendaftaran PKH (Admin) -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Rizka</span>
    ...
    <script src="{{ asset('js/custom-charts.js') }}"></script>
